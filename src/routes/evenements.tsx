...
const AGENDA = [
  {
    ...
    title: "Coupe Epsilon",
    text: "Le grand rendez-vous annuel du club, ouvert à tous.",
    highlight: true,
  },
  {
    icon: Sparkles,
    date: "Chaque trimestre",
    title: "Tournoi à thème",
    text: "Un tournoi convivial autour d'un thème original, pour rencontrer d'autres passionnés.",
  },
  {
    icon: Mic,
    date: "Chaque trimestre",
    title: "Conférence",
    text: "Une conférence donnée par les meilleurs joueurs français : ils décortiquent une convention d'enchère ou une situation de jeu de la carte et répondent aux questions.",
  },
  {
    icon: Users,
    date: "Tous les jeudis",
    title: "Soirée au club à 20h",
    text: "Cours par niveau encadrés par des jeunes bridgeurs.",
  },
];
        ...
        <section id="epsilon" className="scroll-mt-24 px-4 py-16 sm:py-20">
          <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-2">
            <img
              ...
              width={1054}
              height={1492}
              className="pop-card w-full object-contain p-3"
            />
            <div>
              <span className="pop-badge bg-coral text-coral-foreground">
              ...
              <p className="mt-4 font-semibold leading-relaxed text-muted-foreground">
                ...
                dimanche 13 septembre 2026 à 14h participer à un tournoi convivial dont le principe
                est de mélanger les générations : un joueur de moins de 31 ans joue avec un joueur
                de plus de 31 ans.
              </p>
              <p className="mt-4 font-semibold leading-relaxed text-muted-foreground">
                Inscriptions sur le site de la FFB, et n’hésitez pas à nous envoyer un message si
                besoin. L’ambiance est conviviale, le niveau est varié et les rencontres sont
                souvent les plus belles parties de la journée.
              </p>
              ...
              >
                S'inscrire à la Coupe <ExternalLink className="size-4" />
              </a>
            </div>
          </div>
        </section>
              ...
              {AGENDA.map((a) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm font-semibold text-muted-foreground">{a.text}</p>
                  </div>
                </article>
              ))}
            </div>
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-3 font-semibold opacity-90">
                Écrivez-nous à qfjb@parisbridge.fr, ou venez simplement un jeudi soir à 20h : on
                vous expliquera tout autour d'une table.
              </p>
